...
export class PersonsRequest extends jspb.Message { 
    ...
    setIdsList(value: Array<number>): PersonsRequest;
...
export class PersonsResponse extends jspb.Message { 
    ...
    setPersonList(value: Array<Person>): PersonsResponse;
    addPerson(value?: Person, index?: number): Person;
...
export namespace PersonsResponse {
    export type AsObject = {
        personList: Array<Person.AsObject>,
    }
}
